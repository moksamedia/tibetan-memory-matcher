...
test('should return text for exact times', () => {
  expect(getTimeAsText("11","00")).toBe('ཆུ་ཚོད་བཅུ་གཅིག་པ་ཏག་ཏག་རེད།')
  expect(getTimeAsText("12","00")).toBe('ཆུ་ཚོད་བཅུ་གཉིས་པ་ཏག་ཏག་རེད།')
  expect(getTimeAsText("1","00")).toBe('ཆུ་ཚོད་དང་པོ་ཏག་ཏག་རེད།')
})

test('should return text for exactly half past times', () => {
  expect(getTimeAsText("10","30")).toBe('ཆུ་ཚོད་བཅུ་པ་དང་ཕྱེད་ཀ་རེད།')
  expect(getTimeAsText("12","30")).toBe('ཆུ་ཚོད་བཅུ་གཉིས་པ་དང་ཕྱེད་ཀ་རེད།')
  expect(getTimeAsText("4","30")).toBe('ཆུ་ཚོད་བཞི་པ་དང་ཕྱེད་ཀ་རེད།')
})

test('should return text for more than half past times', () => {
  expect(getTimeAsText("10","35")).toBe('ཆུ་ཚོད་བཅུ་གཅིག་པ་ཟིན་པར་སྐར་མ་ཉི་ཤུ་རྩ་ལྔ་འདུག')
...
test('should return text for less than half past times', () => {
  ...
  expect(getTimeAsText("12","11")).toBe('ཆུ་ཚོད་བཅུ་གཉིས་པ་ཡོལ་ནས་སྐར་མ་བཅུ་གཅིག་རེད།')
